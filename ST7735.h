...
#define ST7735_TFTWIDTH  (uint8_t) 128
#define ST7735_TFTHEIGHT (uint8_t) 160
...
/**
 * Initialize the LCD and fill the screen in black
 */
void LcdInit();
...
void OutputFixedPoin(FixedPoint f);
